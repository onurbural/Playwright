...
namespace UITests
{
    ...
    public class UnitTest1 : PageTest
    {
        ...
        public async Task SearchHotel()
        {
            ...
            await loginPage.LoginTest("honurbural", "123456", "https://adactinhotelapp.com/");
            await searchPage.SearchHotel("Sydney", "Hotel Creek", "Super Deluxe", "19/07/2024");
        }
        ...
        public async Task SelectHotel()
        {
            ...
            await loginPage.LoginTest("honurbural", "123456", "https://adactinhotelapp.com/");
            await searchPage.SearchHotel("Sydney", "Hotel Hervey", "Super Deluxe", "19/07/2024"); await selectPage.SelectHotel();
        }
